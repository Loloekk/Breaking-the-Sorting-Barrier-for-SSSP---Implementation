...
int main()
{
    ...
    int seed = 0;
    int fails = 0;
    std::cout << "--- Starting Correcteness Tests ---" << std::endl;
    for (int i = 0; i < 5; i++)
    {
        int N_nodes = 100;
        auto edges = binomialRandomGraphGenerator(N_nodes, 7, 10, 1, MAX_WEIGHT, true, seed++);

        if (!runSolutions(N_nodes, edges, "Dense Asimmetric Binomial Random Graph ", N, false))
        {
            fails++;
            //break;
        }
    ...
    for (int i = 0; i < 5; i++)
    {
        ...
        if (!runSolutions(N_nodes, edges, "Sparse Asimmetric Binomial Random Graph", N, false))
        {
            fails++;
            //break;
        }
    ...
    for (int i = 0; i < 5; i++)
    {
        ...
        if (!runSolutions(N_nodes, edges, "High Asimmetric Random Graph", N, false))
        {
            fails++;
            //break;
        }
    ...
    for (int i = 0; i < 5; i++)
    {
        ...
        if (!runSolutions(N_nodes, edges, "High Random Tree", N, false))
        {
            fails++;
            //break;
        }
    ...
    for (int i = 0; i < 5; i++)
    {
        ...
        if (!runSolutions(N_nodes, edges, "Low Random Tree", N, false))
        {
            fails++;
            //break;
        }
    ...
    for (int i = 0; i < 5; i++)
    {
        ...
        if (!runSolutions(N_nodes, edges, "Sparse Asimmetric Random Graph", N, false))
        {
            fails++;
            //break;
        }
    ...
    for (int i = 0; i < 5; i++)
    {
        ...
        if (!runSolutions(N_nodes, edges, "Dense Asimmetric Random Graph", N, false))
        {
            fails++;
            //break;
        }
    ...
    for (int i = 0; i < 5; i++)
    {
        ...
        if (!runSolutions(N_nodes, edges, "Dense Simmetric Binomial Random Graph ", N, false))
        {
            fails++;
            //break;
        }
    ...
    for (int i = 0; i < 5; i++)
    {
        ...
        if (!runSolutions(N_nodes, edges, "Sparse Simmetric Binomial Random Graph", N, false))
        {
            fails++;
            //break;
        }
    ...
    for (int i = 0; i < 5; i++)
    {
        ...
        if (!runSolutions(N_nodes, edges, "High Simmetric Random Graph", N, false))
        {
            fails++;
            //break;
        }
    ...
    for (int i = 0; i < 5; i++)
    {
        ...
        if (!runSolutions(N_nodes, edges, "Sparse Simmetric Random Graph", N, false))
        {
            fails++;
            //break;
        }
    ...
    for (int i = 0; i < 5; i++)
    {
        ...
        if (!runSolutions(N_nodes, edges, "Dense Simmetric Random Graph", N, false))
        {
            fails++;
            //break;
        }
    ...
    std::cout << "--- Correcteness Tests Finished ---" << std::endl
              << std::endl
              << std::endl;
    return 0;
}